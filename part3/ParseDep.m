function [Node_n_plus Node_n_minus Node_nc_plus Node_nc_minus ...
  Values Names] = ParseDep(netlist, instances_key)
...
for line_number = 2:1:numel(netlist)
    ...
    if line(1) == upper(instances_key)
        ...
        Node_n_plus = [Node_n_plus splitted_line(2)];
        Node_n_minus = [Node_n_minus splitted_line(3)];
        Node_nc_plus = [Node_nc_plus splitted_line(4)];
        Node_nc_minus = [Node_nc_minus splitted_line(5)];
